...
{
    internal class InsertEmployeeDetails
    {
        public static string connection = @"Data Source=DESKTOP-2LOKNJ2\SQLEXPRESS;Initial catalog=Employee_Payroll;Integrated Security=true";
